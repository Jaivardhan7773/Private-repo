...
//     const mailOptions = {
//       from: `"Trending Topics Blogs" <${process.env.USER_EMAIL}>`,
//       to: email,
//       subject: "🔐 Reset Your Password - Trending Topics OTP",
//       html: `
...
//           <p style="font-size: 16px;">We received a request to reset your Trending Topics password. Use the OTP below to proceed:</p>
...
//           </div>
//           <p style="text-align: center; font-size: 14px; color: #888;">© 2025 Trending Topics Blogs. All rights reserved.</p>
//         </div>
//       `
//     };
