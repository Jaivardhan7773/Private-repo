      ...
      <Container>
        <Row className="g-5">
          ...
          <Col lg={4}>
            ...
            <div className='d-flex gap-3'>
              ...
              <a href="https://www.instagram.com/jayvardhannsingh/" target="_blank" className="text-secondary hover-accent"><Instagram size={20} /></a>
          ...
          <Col lg={4}>
            ...
            <h5 className="text-uppercase fw-bold mb-3 mt-4" style={{ color: 'var(--text-primary)', letterSpacing: '1px' }}>Legal</h5>
            <ul className="list-unstyled d-flex flex-column gap-2" style={{ fontFamily: 'var(--font-mono)' }}>
              <li><NavLink to="/privacy-policy" className="text-decoration-none text-secondary hover-accent d-flex align-items-center gap-2"><ArrowRight size={14} /> PRIVACY POLICY</NavLink></li>
              <li><NavLink to="/terms-of-service" className="text-decoration-none text-secondary hover-accent d-flex align-items-center gap-2"><ArrowRight size={14} /> TERMS OF SERVICE</NavLink></li>
              <li><NavLink to="/contact-us" className="text-decoration-none text-secondary hover-accent d-flex align-items-center gap-2"><ArrowRight size={14} /> CONTACT US</NavLink></li>
            </ul>
          </Col>
        ...
        <div className="border-top border-secondary mt-5 pt-4 text-center">
          <p className="mb-0 small font-monospace text-muted">
            &copy; {new Date().getFullYear()} Trending Topics SYSTEMS. DEVELOPED BY <a href="https://jaivardhan.vercel.app" target="_blank" className="text-accent text-decoration-none">JAIVARDHAN</a>.
            <br />
            ALL RIGHTS RESERVED.
          </p>
        </div>
