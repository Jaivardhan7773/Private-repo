...
const AboutUs = () => {
  ...
  return (
    <>
      <SEO
        title="About Us"
        description="Learn more about Trending Topics, our mission, and the team behind the content."
        url="/aboutus"
      />
            ...
            <Row className="align-items-center">
              <Col lg={6} md={6} className="text-center text-lg-start mb-4 mb-lg-0">
                ...
                <h1 className="fw-bold mb-4 display-4" style={{ fontFamily: 'var(--font-main)', color: 'var(--text-primary)', letterSpacing: '-1px' }}>
                  DISCOVER <span style={{ color: 'var(--accent-primary)' }}>Trending Topics</span>
                </h1>
                <p className="lead text-secondary mb-5" style={{ lineHeight: '1.8' }}>
                  Trending Topics is your go-to destination for all things Desi Hip-Hop blogs, delivering the latest news, Memes, updates, and trends in the Indian blog scene. Stay tuned for exclusive content, artist interviews, and much more!
                </p>
                <button
