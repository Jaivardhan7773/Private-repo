...
const Home = () => {
  ...
  return (
    <>
      <SEO
        title="Home"
        description="Welcome to Trending Topics - Your ultimate destination for blogs, music, and entertainment."
        url="/"
      />
      <Carousel />
      <Allblogs />
            ...
            <div className="col-md-6">
              <div className="glass-panel h-100 p-0 overflow-hidden" style={{ position: 'relative', minHeight: '300px' }}>
                <img
                  ...
                  alt="Trending Topics Merchandise"
                  loading="lazy"
